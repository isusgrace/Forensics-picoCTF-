...
ฉันลองดูแต่ละแพ็กเกจ สังเกตที่ Data payload จะมีข้อความที่ดูเหมือนถูกเข้ารหัสด้วย Base64 ดังภาพที่ 2 แต่ Len ของบางแพ็กเกจไม่เหมือนกัน ฉันจึงคลิกที่ Time ดังภาพที่ 1 
...
สังเกตแพ็กเกจแรกที่มี Len=12 ดังภาพที่ 3 ฉันจำได้ว่ารูปแบบของ flag คือ "cGljb0NURg==" ในกรณีที่ถูกเข้ารหัสด้วย Base64

แสดงว่า flag ถูกแยกชิ้นส่วน และชิ้นส่วนของ flag แต่ละชิ้นส่วนอยู่ในแพ็กเกจที่มี Len=12 ให้เรา copy โดยการคลิกขวา แล้วเลือก "...as ASCII Text" เอาเฉพาะส่วนที่ถูกเข้ารหัสด้วย Base4 ดังภาพที่ 2

คัดลอกมาทุกแพ็กเกจที่มี Len=12 โดยเรียงจากบนลงล่าง และคัดลอก "fQ==" ที่อยู่ในแพ็กเกจสุดท้ายที่มี Len=4 มาด้วย เพราะนั่นคือวงเล็บปีกกาปิด
