...
คำสั่ง mkdir ใช้สำหรับสร้างไดเรกทอรี (หรือโฟลเดอร์) ใหม่บนระบบปฏิบัติการคอมพิวเตอร์ ผ่าน Command Line โดยสามารถสร้างโฟลเดอร์เดียว สร้างหลายโฟลเดอร์พร้อมกัน สร้างโฟลเดอร์ซ้อนกันหลายชั้น และสร้างโฟลเดอร์พร้อมกำหนดสิทธิ์ได้ ในข้อนี้เราจะใช้คำสั่ง mkdir สำหรับสร้างโฟลเดอร์เดียว
```
┌──(kali㉿kali)-[~/Downloads]
└─$ mkdir isusgrace05                                                    
```
