...
exiftool ใช้สำหรับอ่าน, เขียน และแก้ไขข้อมูลเมตาที่ฝังอยู่ในไฟล์ เช่น รูปภาพ วิดีโอ และเสียง โดยข้อมูลเหล่านี้ได้แก่ วันที่ถ่าย, การตั้งค่ากล้อง, ตำแหน่ง GPS และข้อมูลอื่นๆ
